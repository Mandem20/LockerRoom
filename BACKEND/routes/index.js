...
router.post("/export-report",authToken,exportReport)
router.get("/all-orders",authToken,getAllOrders)
router.post("/update-order-status",authToken,updateOrderStatus)
router.get("/download-invoice",authToken,downloadInvoice)
router.post("/update-user",authToken,updateUser)
router.post("/delete-user",authToken,deleteUser)
router.post("/toggle-user-status",authToken,toggleUserStatus)
...
router.post("/update-inventory",authToken,updateInventory)
