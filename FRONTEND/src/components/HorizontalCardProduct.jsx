  ...
  return (
    ...
    <div className='flex items-center gap-2 md:gap-6 overflow-x-scroll scrollbar-none transition-all' ref={scrollElement}>
         ...
         {  loading ? (
                    ...
                    return(
             <div className='w-40 sm:w-48 md:w-56 lg:w-64 min-w-[160px] sm:min-w-[190px] md:min-w-[220px] h-[140px] sm:h-[150px] md:h-[165px] bg-white rounded-sm shadow flex' key={"Horizon"+index}>
                   <div className='bg-white-200 h-full p-2 md:p-4 min-w-[80px] sm:min-w-[100px] md:min-w-[120px] shadow animate-pulse'>
