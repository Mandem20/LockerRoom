...
const RecommendedProductDisplay = ({category, heading}) => {
    ...
    <div className='grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
        
         {
              ...
              loading ? (
                    ...
                    return(
             <div className='w-full min-w-[340px]  md:min-w-[320px] max-w-[300px] md:max-w-[330px]  bg-white rounded-sm shadow'>
                  ...
                  data.map((product,index)=>{
                    return(
             <Link to={"/product/"+product?._id} className='w-full min-w-[340px]  md:min-w-[320px] max-w-[300px] md:max-w-[330px]  bg-white rounded-sm shadow' onClick={scrollTop}>
...
export default RecommendedProductDisplay