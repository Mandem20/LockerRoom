  ...
  return (
    <div className='container mx-auto px-4 my-6 relative'>
             ...
             <div className='flex items-center justify-between'>
              ...
              {category && (
                <Link to={`/search?category=${encodeURIComponent(category)}`} className='text-red-600 hover:text-red-700 font-medium text-sm'>
                  See All
                </Link>
              )}
             </div>
        ...
        <div ref={scrollRef} className='flex gap-4 overflow-x-auto scrollbar-none scroll-smooth px-8'>
          
          {
               ...
               loading ? (
                     ...
                     return(
              <div className='min-w-[280px] bg-white rounded-sm shadow'>
                   ...
                   <div className='p-4 grid gap-3'>
                     ...
                     <div className='flex gap-3'>
                         <p className='text-red-600 font animate-pulse rounded-medium p-1-full bg-slate-200 py-2'></p>
                    ...
                    data.filter(product => product.productImage?.length > 0).map((product)=>{
                      return(
