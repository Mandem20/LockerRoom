        ...
        <div className='bg-white p-5 w-full max-w-sm mx-auto'>
          ...
          <div className='flex border rounded mb-4'>
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium ${loginMethod === 'email' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-600'}`}
            >
              Email
            </button>
            <button
              onClick={() => { setLoginMethod('mobile'); setOtpSent(false) }}
              className={`flex-1 py-2 text-sm font-medium ${loginMethod === 'mobile' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-600'}`}
            >
            ...
            <div className='mb-4'>
              ...
              <div className='bg-slate-100 p-2'>
                <input
                  ...
                  required
                  className='w-full h-full outline-none bg-transparent text-center text-lg'
                  maxLength={6}
                />
              </div>
              <button
          ...
          <p className='my-5'>Don't have an account? <Link to={'/sign-up'} className='text-black-600 hover:underline hover: text-red-700'>Sign up</Link></p>
        </div>
      </div>
    </section>
  )
